                ...
                <div className="col-12 col-lg-6">
                  <div className="image-zoom-section">
                    ...
                    >
                      <div className="item">
                        <img
                          src="assets/images/product-gallery/01.png"
                          className="img-fluid"
                          alt=""
                        />
                      </div>
                      <div className="item">
                        <img
                          src="assets/images/product-gallery/02.png"
                          className="img-fluid"
                          alt=""
                        />
                      </div>
                      <div className="item">
                        <img
                          src="assets/images/product-gallery/03.png"
                          className="img-fluid"
                          alt=""
                        />
                      </div>
                      <div className="item">
                        <img
                          src="assets/images/product-gallery/04.png"
                          className="img-fluid"
                          alt=""
                        />
                      </div>
                ...
                <div className="col-12 col-lg-6">
                  <div className="product-info-section p-3">
                    ...
                    <div className="d-flex gap-2 mt-3">
                      <a href="javascript:;" className="btn btn-dark btn-ecomm">
                        {" "}
